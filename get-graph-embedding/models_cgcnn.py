# Pol Benítez Colominas, May 2025 - Jan 2026
# The University of Tokyo and Universitat Politècnica de Catalunya

# GNN models (with extra function to return the embedding of the graph)
...
class model1(torch.nn.Module):
    ...
    def get_embedding(self, x, edge_index, edge_attr, batch):
        """
        Executes the GNN model until the linear layers in order to return the graph embedding
        """
