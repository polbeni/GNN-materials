# Pol Benítez Colominas, January 2024 - July 2024
# Universitat Politècnica de Catalunya

# Code to generate graphs from unit cell structure files (as cif or POSCAR files), with edge multifeature
...
def get_edges(struct, lim_dist):
    ...
    features of each element of the adjecent list, here the euclidean, x, y, and z distances. In order to do this a proper 
    ...
    for atom in range(atoms_number):
        for atom_super in range(atoms_supercell_number - atom*(n_supercell**3)):
            ...
            if (euclidean_distance <= lim_dist) and (euclidean_distance > 1e-5): 
                ...
                edge_feature = [euclidean_distance, a_dist, b_dist, c_dist]
...
structures_path = '/home/pol/work/crystal-graph-neural-networks/materials-dataset-new/structures/'
...
for struc_path in structures_list:
    ...
    if discarted == False:
        ...
        path_to_save = struc_path.split('/')[7].split('.')[0]
