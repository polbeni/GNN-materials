...
# This script retrains a previously trained CGCNN model
...
with open('../graphs-retrain-HSEsol/graphs-bg.csv', 'r') as csv_file:
...
path_data = '../graphs-retrain-HSEsol/normalized_graphs/'

df_materials = pd.read_csv('../graphs-retrain-HSEsol/graphs-bg.csv')
...
max_output = 2 #6.950200080871582
min_output = 0 #0.05009999871253967
