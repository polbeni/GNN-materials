...
################################ PARAMETERS ###############################
num_epochs = 500                                                        # Number of epochs in the training
learning_rate = 1e-3                                                    # Value of the learning rate step
...
database_type = 'both'                                                  # Graphs to use as the database (uniform, phononic, or both)
