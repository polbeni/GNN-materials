...
# Saves the atom features dictionary into json file
...
atoms_dict = {
    # chemical compound: (number (from 0 to 88), electronegativity, weight (u), radius (pm))
    # data obtained from: https://ptable.com/#Properties
    # none elements from some features have been changed by a reasonable value (by hand for the elctronegativity), 
    # and from https://en.wikipedia.org/wiki/Atomic_radii_of_the_elements_(data_page) 
    # for the radius (calculated column for La and Ce, and Covalent (single bond) column for Ac, Th, Pa, U, Np and Pu)
    'H': (0, 2.20, 1.008, 53),
    'He': (1, 2.22, 4.0026, 31),
    'Li': (2, 0.98, 6.94, 167),
    'Be': (3, 1.57, 9.0122, 112),
...
with open('atoms_dict.json', 'w') as json_file:
    json.dump(atoms_dict, json_file)